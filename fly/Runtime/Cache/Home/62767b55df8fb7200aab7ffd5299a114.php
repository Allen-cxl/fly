...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<link href="/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
        <link href="/Public/Home/twentynineteen/css/login.css" rel="stylesheet">
...
<article id="post-12" class="post-12 page type-page status-publish hentry entry">
  ...
  <div class="container">
    <form class="login" id="myform" onsubmit="comment()"  action="javascript:void(0)">
      <h2 class="title">登录</h2>
      <p>
        <span class="fa fa-mobile"></span>
        <input id="username" type="email" name="username" placeholder="邮箱" required />
      </p>
      <p>
      ...
      <p>
        ...
        <input id="verifycode" type="text" name="vcode" autocomplete="off" placeholder="验证码" required />
      </p>
      <p class="vcode">
      ...
      <p class="text-center">
        <input type="submit" id="do-login" style="background-color: #20407d;
    color: white;
    border: 0px;
    width: 300px;
    padding: 8px;
    outline: none;
    border-radius: 2px;" value="登陆" />
      </p>
      <p class="text-center">
       
        <small>还没有账号? </small>
        <a href="/home/login/reg"><small>现在注册</small></a>
      </p>
...
function comment(){
		$.post("/home/login/login/url/<?php echo ($url); ?>",$("#myform").serialize(),function(data){
				if(data.s=="1"){
