...
<!--上传图片插件end-->
	...
	<form action="" method="post" class="form-horizontal">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($data["port"]); ?>" name="port" class="text input-large">
				<input type="hidden" value="<?php echo ($data["id"]); ?>" name="id" class="text input-large">
				<input type="hidden" value="<?php echo ($pid); ?>" name="pid" class="text input-large">
			</div>
		</div>
		<div class="form-item cf">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($data["sort"]); ?>" name="sort" class="text input-large">
	...
	<script type="text/javascript">
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U("fly/ports");?>');
		})
	</script>
