...
<body>
		...
		<table>
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><a href="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/<?php echo ($vo["wurl"]); ?>"><?php echo ($vo["wname"]); ?></a></td>
						<td>
							<a class="confirm ajax-get" title="删除" href="<?php echo U('fly/redel','id='.$vo["id"]);?>">删除</a>
							<a class="confirm ajax-get" title="确认" href="<?php echo U('fly/resub','id='.$vo["id"]);?>"><?php if(($vo["state"]) == "0"): ?>确认<?php else: ?>取消确认<?php endif; ?></a>
						</td>
					</tr>
	...
	$(".search-input").keyup(function(e){
		...
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U('fly/record');?>');
		})
	</script>
