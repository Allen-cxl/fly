...
<!--上传图片插件end-->
	...
	<form action="" method="post" class="form-horizontal">
		...
		<div class="form-item cf">
			<label class="item-label">中文名称<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["cname"]); ?>"  name="cname" class="text input-large addport">
				<div></div>		
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text"  value="<?php echo ($data["ename"]); ?>" name="ename" class="text input-large addport">
				<div></div>	
				
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">航空代码<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text"  value="<?php echo ($data["code"]); ?>" name="code" class="text input-large addport">
				<div></div>	
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text"  value="<?php echo ($data["sort"]); ?>" name="sort" class="text input-large addport">
				<div></div>	
	...
	<script type="text/javascript">
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U("fly/company");?>');
		})
	</script>
