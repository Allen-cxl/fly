...
<body>
	...
	<div class="cf">
	<div class="fl">
			<a class="btn" href="<?php echo U("fly/cedite");?>">新 增</a>
		</div>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('company');?>"><i class="btn-search"></i></a>
			</div>
		</div>
	</div>
	<!-- 数据列表 -->
		...
		<table>
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<!--<td style="background-color:gray;"><img src="<?php echo ($vo["pic"]); ?>" width="80"/></td>-->
						...
						<td>
							<a  title="编辑" href="<?php echo U('fly/cedite','id='.$vo["id"]);?>">编辑</a>
							<a class="confirm ajax-get" title="删除" href="<?php echo U('fly/cdel','id='.$vo["id"]);?>">删除</a>
						</td>
					</tr>
