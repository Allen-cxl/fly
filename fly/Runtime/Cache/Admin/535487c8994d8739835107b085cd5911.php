...
<div class="search-form fr cf">
			...
			<input style="float:left;    padding: 2px 4px;margin:0 5px 0 0;" name="uid" value="<?php echo I("get.uid");?>" placeholder="用户ID" />
			
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('lists');?>"><i class="btn-search"></i></a>
			</div>
		</div>
	<!-- 数据列表 -->
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							...
							<a title="上下分" href="javascript:changepwd(<?php echo ($vo["id"]); ?>)">修改密码</a>　
							<a class="confirm ajax-get" title="删除" href="<?php echo U('tuser/del','id='.$vo["id"]);?>">删除</a>
						</td>
...
$("#submit").click(function(){
	...
	if(pwd==""){
		...
		$.post("<?php echo U("tuser/changepwd");?>",{id:id,pwd:pwd},function(result){
			if(result=="ok"){
	...
	$(".search-input").keyup(function(e){
		...
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U('money/lists');?>');
		})
	</script>
