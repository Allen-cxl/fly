   ...
   <script type='text/javascript' src='/Public/Admin/uploade/jquery-2.0.3.min.js'></script>
	...
	<form action="" method="post" class="form-horizontal">
		...
		<div class="form-item cf">
			<label class="item-label">编号<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["num"]); ?>"  name="num" class="text input-large addport">
			
				
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">代码<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["code"]); ?>" name="code" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text"  value="<?php echo ($data["company"]); ?>"   name="company" class="text input-large addport">
				<div></div>	
				
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">跳转地址<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["url"]); ?>" name="url" class="text input-large">
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U("fly/goodslist");?>');
