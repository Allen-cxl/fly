...
<body>
	...
	<div class="cf">
	<div class="fl">
            <a class="btn" href="<?php echo U("fly/gedite");?>">新 增</a>
        </div>
        <!-- 高级搜索 -->
		...
		<table>
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a  title="编辑" href="<?php echo U('fly/gedite','id='.$vo["id"]);?>">编辑</a>
							<a class="confirm ajax-get" title="删除" href="<?php echo U('fly/gdel','id='.$vo["id"]);?>">删除</a>
						</td>
					</tr>
