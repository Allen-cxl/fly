...
<!--上传图片插件end-->
	...
	<form action="" method="post" class="form-horizontal">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($data["cportcode"]); ?>" id="cportc" name="cportcode" class="text input-large">
			</div>
		</div>
		<div class="form-item cf">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($data["mportcode"]); ?>" id="mportc" name="mportcode" class="text input-large">
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">城市<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["mcity"]); ?>" name="mcity" class="text input-large">
			</div>
		</div>
		<div class="form-item cf">
                    ...
                    <div class="controls">
                        <div class="controls">
									...
									<input type="hidden" name="pic" value="<?php echo ($data["pic"]); ?>" class="inputpic" />
									<div class="upload-img-box">
										...
										<!--上传文件条-->
										<div class="upload-pre-item"><img src='<?php echo ((isset($data["pic"]) && ($data["pic"] !== ""))?($data["pic"]):"/Public/Admin/uppic/image.jpg"); ?>' /></div>
									</div>
								</div>
						 </div>
         </div>	
		<div class="form-item cf">
			...
			<div class="controls">
				<select id="company" name="company">
						<?php if(is_array($cp)): foreach($cp as $key=>$vo): ?><option value="<?php echo ($key); ?>" ><?php echo ($vo); ?></option><?php endforeach; endif; ?>			
									                           
					</select>
			</div>
		</div>
<script>
$("#company").val("<?php echo ($data["company"]); ?>");
</script>		
		<div class="form-item cf">
			<label class="item-label">航空公司代码<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["companycode"]); ?>" name="companycode" class="text input-large">
		...
		<div class="form-item cf">
                    ...
                    <div class="controls">
						...
						<?php if(is_array($gt)): foreach($gt as $key=>$vo): ?><option value="<?php echo ($key); ?>" ><?php echo ($vo); ?></option><?php endforeach; endif; ?>			
									                           
					</select>     </div>
                </div>

<script>
$("#goodstype").val("<?php echo ($data["goodstype"]); ?>");
</script>
<div class="form-item cf">
                    <label class="item-label">飞行类型<span class="check-tips"></span></label>
                    <div class="controls">
                        <select id="flytype" name="flytype">
						<?php $flytype=flyType(0,0); ?>
						<?php if(is_array($flytype)): foreach($flytype as $key=>$vo): ?><option value="<?php echo ($key); ?>" ><?php echo ($vo); ?></option><?php endforeach; endif; ?>                        
					</select>     </div>
                </div>

<script>
$("#flytype").val("<?php echo ($data["flytype"]); ?>");
</script>		
		<div class="form-item cf">
			<label class="item-label">价格梯度（用;号隔开）<?php echo gradientPrice(0,3);?><span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["gradient"]); ?>" name="gradient" class="text input-large">
			</div>
		</div>
		<div class="form-item cf">
                    ...
                    <div class="controls">
                        <select id="packingtype" name="packingtype">
                            <?php $packingType=packingType(0,0); ?>
						<?php if(is_array($packingType)): foreach($packingType as $key=>$vo): ?><option value="<?php echo ($key); ?>" ><?php echo ($vo); ?></option><?php endforeach; endif; ?>                            
					</select>     </div>
                </div>

<script>
$("#packingtype").val("<?php echo ($data["packingtype"]); ?>");
</script>
	<div class="form-item cf">
			<label class="item-label">区域<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["region"]); ?>" name="region" class="text input-large">
...
<script>
$("#special").val("<?php echo ($data["special"]); ?>");
</script>
<div class="form-item cf">
...
<script>
$("#hot").val("<?php echo ($data["hot"]); ?>");
</script>
		<div class="form-item cf">
			<label class="item-label">航班<span class="check-tips"></span></label>
			<div class="controls">
			<input type="text" value="<?php echo ($data["flight"]); ?>" name="cycle" class="text input-large">
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">航班周期<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" value="<?php echo ($data["cycle"]); ?>" name="cycle" class="text input-large">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($data["day"]); ?>" name="day" class="text input-large">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($data["starttime"]); ?>" name="starttime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" class="text input-large">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($data["deadline"]); ?>"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" name="deadline" class="text input-large">
...
<div class="form-item cf">
	...
	<script type="text/javascript">
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U("fly/tjlist");?>');
